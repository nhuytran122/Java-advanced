							  ...
							  <td>
							    <div class="btn-group" role="group">
							      <form method="post" action="../admin/edit-user">
							        ...
							        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal<%= user.getUserID() %>" title="Xóa">
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title text-danger" id="deleteModalLabel<%= user.getUserID() %>">
