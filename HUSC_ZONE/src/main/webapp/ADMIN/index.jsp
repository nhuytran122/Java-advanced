...
<%
	...
	int cntPendingReports = (Integer) request.getAttribute("cntPendingReports");
%>
	                ...
	                <a href="../admin/reports?statusID=<%= Constants.REPORT_PENDING %>" class="card card-tale text-decoration-none">
	                  <div class="card card-light-danger">
	                    <div class="card-body">
	                      ...
	                      <p class="fs-30 mb-2"><%= cntPendingReports %></p>
	                    </div>
	                  </div>
	                </a>
                </div>
