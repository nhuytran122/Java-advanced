...
public class DocumentDao {
	public ArrayList<Document> getListDocs(int page, int pageSize, String searchValue, 
		            Long categoryID, Long materialID, Long userID) throws Exception {
		...
		while (rs.next()) {
			...
			ds.add(new Document(documentID, title, description, createdAt, updatedAt, filePath, catID, matID, uploadedBy));
		}
		rs.close();
		cmd.close();
		kn.cn.close();
