...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <ul class="nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="adminSachController" aria-expanded="false">
      ...
      <li class="nav-item">
        <a class="nav-link" href="adminLoaiController" aria-expanded="false">
          <i class="bi bi-bookmarks menu-icon"></i>
          <span class="menu-title">Loại sách</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="adminKHController" aria-expanded="false">
      ...
      <li class="nav-item">
        <a class="nav-link" href="adminOrderController" aria-expanded="false" >
          <i class="bi bi-receipt menu-icon"></i>
