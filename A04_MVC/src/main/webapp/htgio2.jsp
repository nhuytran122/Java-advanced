    ...
    <div class="container mt-3">
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <form method="post" action="xoasua.jsp">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            %>
                                <tr>
                                    <td>
                                        <input type="checkbox" name="ck" value="<%= sachId %>" />
                                    </td>
                                    <td><%= s.getTensach() %></td>
                                    <td><%= s.getGia() %></td>
                                    <td>
                                         <input type="number" name="<%=sachId %>" value="<%= hang.getSoluong() %>" style="width: 75px" class="form-control">
                    ...
                    <div class="text-end mb-3">
                        <button type="submit" name="btnxoachon" value="Xoa" class="btn btn-danger me-2">Xóa đã chọn</button>
                        <button type="submit" name="btnXoaAll" value="deleteAll" class="btn btn-danger">Xóa tất cả</button>
                    </div>
                </form>
